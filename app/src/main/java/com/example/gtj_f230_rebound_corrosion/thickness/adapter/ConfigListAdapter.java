...
public class ConfigListAdapter extends BaseQuickAdapter<ConfigBean, QuickViewHolder> {
    private final int colorFFF, color4CB4B9, color333;
    private final boolean isCreatePage;

    public ConfigListAdapter(Context context, boolean isCreatePage) {
        super();
    ...
    protected void onBindViewHolder(@NotNull QuickViewHolder holder, int position, ConfigBean item) {
        ...
        holder.setText(R.id.textView, item.poleName);
