...
public class StyleAlertDialog1 extends Dialog {
    ...
    public StyleAlertDialog1(Context context) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_dialog1);
        initView();
    }
...
//        content.setGravity(Gravity.CENTER);
     ...
     * 设置显示内容
     */
    public StyleAlertDialog1 setContent(CharSequence content) {
        if (tvContent != null) {
     ...
     * 设置按钮
     */
    public StyleAlertDialog1 setLeftButton(CharSequence text, View.OnClickListener listener) {
        leftText = text;
     ...
     * 设置按钮
     */
    public StyleAlertDialog1 setRightButton(CharSequence text, View.OnClickListener listener) {
        rightText = text;
     ...
     * 设置按钮
     */
    public StyleAlertDialog1 setOKButton(CharSequence text, View.OnClickListener listener) {
        okText = text;
        okListener = listener;
        return this;
    }
