...
//        content.setGravity(Gravity.CENTER);
     ...
     * 设置显示内容
     */
    public StyleAlertDialog setContent(CharSequence content) {
        if (tvContent != null) {
     ...
     * 设置按钮
     */
    public StyleAlertDialog setLeftButton(CharSequence text, View.OnClickListener listener) {
        leftText = text;
     ...
     * 设置按钮
     */
    public StyleAlertDialog setRightButton(CharSequence text, View.OnClickListener listener) {
        rightText = text;
     ...
     * 设置按钮
     */
    public StyleAlertDialog setOKButton(CharSequence text, View.OnClickListener listener) {
        okText = text;
        okListener = listener;
        return this;
    }
