...
public class TestingListAdapter1 extends BaseQuickAdapter<Integer, QuickViewHolder> {

    public TestingListAdapter1() {
        super();
    }

    @Override
    protected QuickViewHolder onCreateViewHolder(Context context, ViewGroup parent, int viewType) {
        return new QuickViewHolder(LayoutInflater.from(context).inflate(R.layout.item_testing_list1, parent, false));
    }
